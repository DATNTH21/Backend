...
const { saveRepoTreeToFile, fetchDirectoryTree } = require('../utils/repoUtils');
...
router.post('/select', async (req, res) => {
    ...
    try {
        ...
        await saveRepoTreeToFile(directoryTree, repo);
        res.send(`<h1>Repository Tree for ${repo} saved successfully!</h1><p><a href="/">Go back</a></p>`);
    } catch (error) {
